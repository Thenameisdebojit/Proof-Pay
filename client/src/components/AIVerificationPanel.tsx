  ...
  const handleAnalyze = () => {
    ...
    setTimeout(() => {
      ...
      setResult({
        ...
        gpa: "3.8/4.0",
        confidence: isLowConfidence ? 45 : 98,
  ...
  return (
    <div className="space-y-4 border rounded-xl p-5 bg-slate-50 dark:bg-slate-900/50 dark:border-slate-800">
      <div className="flex items-center justify-between">
        ...
        <Badge variant="outline" className="text-xs uppercase tracking-wider font-bold bg-background">Beta</Badge>
      </div>
      ...
      {!result ? (
        <div className="text-center py-6">
          ...
          <Button onClick={handleAnalyze} disabled={analyzing} className="w-full bg-purple-600 hover:bg-purple-700 text-white">
            {analyzing ? (
              <>
